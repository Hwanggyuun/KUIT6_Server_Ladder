...
class LadderGameTest {
    ...
    public void LadderRun () {
        //given
        LadderCreator ladderCreator =  LadderCreator.of(NaturalNum.of(3), NaturalNum.of(3));
    ...
    public void LadderDrawLine () {
        //given
        LadderCreator ladderCreator =  LadderCreator.of(NaturalNum.of(5), NaturalNum.of(4));
        LadderGame ladderGame = LadderGame.of(ladderCreator);
